...
class RecipesTest < ActionDispatch::IntegrationTest
  ...
  test "should get recipes show" do
   ...
   test "create new valid recipe" do
    ...
    name_of_recipe = "vegeatble saute"
    description_of_recipe = "add rice, add vegetables, cook for 20 minutes, serve delicious meal"
  ...
  test "reject invalid recipes submission " do 
    sign_in_as(@chef, "password")
    get new_recipe_path
    assert_template 'recipes/new'
